...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        methods: {
            ...
            enter(el, done){  // Vue提供的Js函数钩子 来实现酷炫动画
            ...
            _getPosAndScale(){  // 获取执行动画运行轨迹需要的位置和缩放比例
                ...
                const paddingTop = 80;
                const songWidth = window.innerWidth * 0.8;
                const scale = targetWidth / songWidth;
                const x = -(window.innerWidth / 2 - paddingLeft);
                const y = window.innerHeight - paddingTop - (songWidth / 2 ) - paddingBottom;
                return {
                    x,
                    y,
                    scale
